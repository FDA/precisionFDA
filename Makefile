...
prepare-db:
	docker compose -p precision-fda -f docker/dev.docker-compose.yml up --build web db
prepare-db-qa:
	docker compose -p precision-fda-qa -f docker/qa.docker-compose.yml up --build web db
prepare-db-arm64v8-dev:
	docker compose -p precision-fda -f docker/arm64v8.dev.docker-compose.yml up --build web db
prepare-db-arm64v8-qa:
	docker compose -p precision-fda-qa -f docker/arm64v8.qa.docker-compose.yml up --build web db

run:
	docker compose -p precision-fda -f docker/dev.docker-compose.yml up --build
run-qa:
	docker compose -p precision-fda-qa -f docker/qa.docker-compose.yml up --build
run-arm64v8-dev:
	docker compose -p precision-fda -f docker/arm64v8.dev.docker-compose.yml up --build
run-arm64v8-qa:
	docker compose -p precision-fda-qa -f docker/arm64v8.qa.docker-compose.yml up --build

run-all:
	docker compose -p precision-fda -f docker/dev.docker-compose.yml -f docker/external.docker-compose.yml up --build
run-all-qa:
	docker compose -p precision-fda-qa -f docker/qa.docker-compose.yml -f docker/external.docker-compose.yml up --build
run-all-arm64v8-dev:
	docker compose -p precision-fda -f docker/arm64v8.dev.docker-compose.yml -f docker/external.arm64v8.docker-compose.yml up --build
run-all-arm64v8-qa:
