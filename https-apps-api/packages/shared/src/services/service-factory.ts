...
import { INotificationService, NotificationService, RedisClientType } from '../domain/notification/services/notification.service'
...
import { EmailClient, IEmailService } from "./smtp.service"
...
interface IServiceFactory {
  ...
  getNotificationService: (em: SqlEntityManager, redisClient?: RedisClientType) => INotificationService
...
export class ServiceFactory implements IServiceFactory {
  getEmailService(): IEmailService {
    ...
    // if (config.emails.writeToDisk)
    // { return new WriteToDiskEmailClient() }
