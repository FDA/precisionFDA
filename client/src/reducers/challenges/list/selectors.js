export const challengesListSelector = (state) => state.challenges.list.items
export const challengesListIsFetchingSelector = (state) => state.challenges.list.isFetching
