...
import { homeExecutionsSpacesFiltersSelector } from '../../../../reducers/home/executions/selectors'
import { HOME_ENTRIES_TYPES } from '../../../../constants'
import { showAlertAboveAll } from '../../../alertNotifications'


const fetchExecutionsStart = () => createAction(HOME_EXECUTIONS_FETCH_START, HOME_ENTRIES_TYPES.SPACES)

const fetchExecutionsSuccess = (executions, pagination) => createAction(HOME_EXECUTIONS_FETCH_SUCCESS, { executionsType: HOME_ENTRIES_TYPES.SPACES, executions, pagination })

const fetchExecutionsFailure = () => createAction(HOME_EXECUTIONS_FETCH_FAILURE, HOME_ENTRIES_TYPES.SPACES)

export default () => (
  async (dispatch, getState) => {
    const filters = homeExecutionsSpacesFiltersSelector(getState())
    ...
    try {
      const response = await API.getExecutionsSpaces(params)
