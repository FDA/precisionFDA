...
describe('fetchExecutionsEverybody()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/jobs/everybody?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchExecutionsEverybody()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_EXECUTIONS_FETCH_START, payload: HOME_ENTRIES_TYPES.EVERYBODY },
          { type: HOME_EXECUTIONS_FETCH_SUCCESS, payload: { executionsType: HOME_ENTRIES_TYPES.EVERYBODY, executions, pagination }},
        ])
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchExecutionsEverybody()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_EXECUTIONS_FETCH_START, payload: HOME_ENTRIES_TYPES.EVERYBODY },
          { type: HOME_EXECUTIONS_FETCH_FAILURE, payload: HOME_ENTRIES_TYPES.EVERYBODY },
