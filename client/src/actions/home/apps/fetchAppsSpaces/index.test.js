...
import fetchAppsSpaces from './index'
...
describe('fetchAppsSpaces()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/apps/spaces?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchAppsSpaces()).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: HOME_APPS_FETCH_START, payload: HOME_APP_TYPES.SPACES },
          { type: HOME_APPS_FETCH_SUCCESS, payload: { appsType: HOME_APP_TYPES.SPACES, apps, pagination }},
        ]) 
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchAppsSpaces()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_APPS_FETCH_START, payload: HOME_APP_TYPES.SPACES },
          { type: HOME_APPS_FETCH_FAILURE, payload: HOME_APP_TYPES.SPACES },
