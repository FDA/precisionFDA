...
import fetchAppsEverybody from './index'
...
describe('fetchAppsEverybody()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/apps/everybody?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchAppsEverybody()).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: HOME_APPS_FETCH_START, payload: HOME_APP_TYPES.EVERYBODY },
          { type: HOME_APPS_FETCH_SUCCESS, payload: { appsType: HOME_APP_TYPES.EVERYBODY, apps, pagination }},
        ])
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchAppsEverybody()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_APPS_FETCH_START, payload: HOME_APP_TYPES.EVERYBODY },
          { type: HOME_APPS_FETCH_FAILURE, payload: HOME_APP_TYPES.EVERYBODY },
