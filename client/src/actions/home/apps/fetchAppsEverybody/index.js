...
import { homeAppsEverybodyFiltersSelector } from '../../../../reducers/home/apps/selectors'
import { HOME_APP_TYPES, HOME_TABS } from '../../../../constants'
import { showAlertAboveAll } from '../../../alertNotifications'


const fetchAppsStart = () => createAction(HOME_APPS_FETCH_START, HOME_APP_TYPES.EVERYBODY)

const fetchAppsSuccess = (apps, pagination) => createAction(HOME_APPS_FETCH_SUCCESS, { appsType: HOME_APP_TYPES.EVERYBODY, apps, pagination })

const fetchAppsFailure = () => createAction(HOME_APPS_FETCH_FAILURE, HOME_APP_TYPES.EVERYBODY)

export default () => (
  async (dispatch, getState) => {
    const filters = homeAppsEverybodyFiltersSelector(getState())
    ...
    try {
      const response = await API.getAppsEverybody(params)
