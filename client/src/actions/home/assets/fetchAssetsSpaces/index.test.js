...
import fetchAssetsSpaces from './index'
...
describe('fetchAssetsSpaces()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/assets/spaces?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchAssetsSpaces()).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: HOME_ASSETS_FETCH_START, payload: HOME_ENTRIES_TYPES.SPACES },
          { type: HOME_ASSETS_FETCH_SUCCESS, payload: { assetsType: HOME_ENTRIES_TYPES.SPACES, assets, pagination }},
        ])
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchAssetsSpaces()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_ASSETS_FETCH_START, payload: HOME_ENTRIES_TYPES.SPACES },
          { type: HOME_ASSETS_FETCH_FAILURE, payload: HOME_ENTRIES_TYPES.SPACES },
