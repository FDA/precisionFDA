...
const fetchAssetsStart = () => createAction(HOME_ASSETS_FETCH_START, HOME_ENTRIES_TYPES.PRIVATE)

const fetchAssetsSuccess = (assets, pagination) => createAction(HOME_ASSETS_FETCH_SUCCESS, { assetsType: HOME_ENTRIES_TYPES.PRIVATE, assets, pagination })

const fetchAssetsFailure = () => createAction(HOME_ASSETS_FETCH_FAILURE, HOME_ENTRIES_TYPES.PRIVATE)

export default () => (
  async (dispatch, getState) => {
    const filters = homeAssetsFiltersSelector(getState())
