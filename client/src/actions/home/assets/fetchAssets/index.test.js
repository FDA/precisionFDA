...
describe('fetchAssets()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchAssets()).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: HOME_ASSETS_FETCH_START, payload: HOME_ENTRIES_TYPES.PRIVATE },
          { type: HOME_ASSETS_FETCH_SUCCESS, payload: { assetsType: HOME_ENTRIES_TYPES.PRIVATE, assets, pagination }},
        ])
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchAssets()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_ASSETS_FETCH_START, payload: HOME_ENTRIES_TYPES.PRIVATE },
          { type: HOME_ASSETS_FETCH_FAILURE, payload: HOME_ENTRIES_TYPES.PRIVATE },
