...
import { homeAssetsFeaturedFiltersSelector } from '../../../../reducers/home/assets/selectors'
import { HOME_ENTRIES_TYPES, HOME_TABS } from '../../../../constants'
import { showAlertAboveAll } from '../../../alertNotifications'


const fetchAssetsStart = () => createAction(HOME_ASSETS_FETCH_START, HOME_ENTRIES_TYPES.FEATURED)

const fetchAssetsSuccess = (assets, pagination) => createAction(HOME_ASSETS_FETCH_SUCCESS, { assetsType: HOME_ENTRIES_TYPES.FEATURED, assets, pagination })

const fetchAssetsFailure = () => createAction(HOME_ASSETS_FETCH_FAILURE, HOME_ENTRIES_TYPES.FEATURED)

export default () => (
  async (dispatch, getState) => {
    const filters = homeAssetsFeaturedFiltersSelector(getState())
    ...
    try {
      const response = await API.getAssetsFeatured(params)
