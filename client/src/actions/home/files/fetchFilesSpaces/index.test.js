...
import fetchFilesSpaces from './index'
...
describe('fetchFilesSpaces()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/files/spaces?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchFilesSpaces()).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: HOME_FILES_FETCH_START, payload: HOME_FILE_TYPES.SPACES },
          { type: HOME_FILES_FETCH_SUCCESS, payload: { filesType: HOME_FILE_TYPES.SPACES, files, pagination, path }},
        ]) 
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchFilesSpaces()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_FILES_FETCH_START, payload: HOME_FILE_TYPES.SPACES },
          { type: HOME_FILES_FETCH_FAILURE, payload: HOME_FILE_TYPES.SPACES },
