...
import { homeFilesEverybodyFiltersSelector } from '../../../../reducers/home/files/selectors'
import { HOME_FILE_TYPES } from '../../../../constants'
import { showAlertAboveAll } from '../../../alertNotifications'


const fetchFilesStart = () => createAction(HOME_FILES_FETCH_START, HOME_FILE_TYPES.EVERYBODY)

const fetchFilesSuccess = (files, pagination, path) => createAction(HOME_FILES_FETCH_SUCCESS, { filesType: HOME_FILE_TYPES.EVERYBODY, files, pagination, path })

const fetchFilesFailure = () => createAction(HOME_FILES_FETCH_FAILURE, HOME_FILE_TYPES.EVERYBODY)

export default (folderId) => (
  async (dispatch, getState) => {
    const filters = homeFilesEverybodyFiltersSelector(getState())
    ...
    try {
      const response = await API.getFilesEverybody(params)
