...
import { HOME_DATABASES_MODALS } from '../../../../constants'


const terminateStart = () => createAction(HOME_DATABASE_MODAL_ACTION_START, HOME_DATABASES_MODALS.TERMINATE)

const terminateSuccess = () => createAction(HOME_DATABASE_MODAL_ACTION_SUCCESS, HOME_DATABASES_MODALS.TERMINATE)

const terminateFailure = () => createAction(HOME_DATABASE_MODAL_ACTION_FAILURE, HOME_DATABASES_MODALS.TERMINATE)
