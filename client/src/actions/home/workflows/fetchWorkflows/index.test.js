...
describe('fetchWorkflows()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    const url = '/api/workflows?page=1'
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(fetchWorkflows()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_WORKFLOWS_FETCH_START, payload: HOME_WORKFLOW_TYPES.PRIVATE },
          { type: HOME_WORKFLOWS_FETCH_SUCCESS, payload: { workflowsType: HOME_WORKFLOW_TYPES.PRIVATE, workflows, pagination }},
        ])
      })
    })
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(fetchWorkflows()).then(() => {
        ...
        expect(actions).toEqual([
          { type: HOME_WORKFLOWS_FETCH_START, payload: HOME_WORKFLOW_TYPES.PRIVATE },
          { type: HOME_WORKFLOWS_FETCH_FAILURE, payload: HOME_WORKFLOW_TYPES.PRIVATE },
