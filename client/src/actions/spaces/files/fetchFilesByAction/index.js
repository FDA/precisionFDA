...
const fetchFilesByActionStart = (action) => createAction(SPACE_FETCH_FILES_BY_ACTION_START, action)

const fetchFilesByActionSuccess = (action, files) => createAction(SPACE_FETCH_FILES_BY_ACTION_SUCCESS, { action, files })
