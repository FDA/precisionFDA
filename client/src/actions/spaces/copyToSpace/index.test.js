...
describe('copyToSpace()', () => {
  ...
  describe('dispatch actions', () => {
    ...
    it('dispatches correct actions on success response', () => {
      ...
      return store.dispatch(copyToSpace(copyLink, scope, ids)).then(() => {
        const actions = store.getActions()

        expect(actions).toEqual([
          { type: COPY_OBJECTS_TO_SPACE_START, payload: {}},
          { type: COPY_OBJECTS_TO_SPACE_SUCCESS, payload: {}},
          {
    ...
    it('dispatches correct actions on failure response', () => {
      ...
      return store.dispatch(copyToSpace(copyLink, scope, ids)).then(() => {
        ...
        expect(actions).toEqual([
          { type: COPY_OBJECTS_TO_SPACE_START, payload: {}},
          { type: COPY_OBJECTS_TO_SPACE_FAILURE, payload: {}},
          {
            type: ALERT_SHOW_ABOVE_ALL, payload: {
