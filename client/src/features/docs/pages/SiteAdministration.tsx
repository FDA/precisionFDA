...
export const SiteAdministration = () => (
  <DocBody>
    ...
    <p>
      Site administrators on precisionFDA are able to provide some services for
      users, including viewing account activations, resending activation emails,
      modifying user profiles, and granting account unlocks and multi-factor
      authentication resets. Additionally, site administrators are able to
      manually enable and disable accounts.
    </p>
    ...
    <p>
      Clicking on the “Active Users” button under Site Activity brings up a list
      of all active users, with additional tools to sort and filter the list.
    </p>
    ...
    <p>
      Clicking on an individual user brings up additional information about that
      user's account.
    </p>

    <img width="100%" src={exploringusers2} alt="Additional user information" />
    ...
    <img width="100%" src={exploringusers3} alt="Deactivate user modal popup" />

    <h2 id="pending-users">Pending Users</h2>

    <p>
      Clicking on Pending Users from the Admin Dashboard brings up a list of all
      pending users - users for whom accounts have been provisioned, but have
      not yet been activated by the user. Here, the admin has the option to
    ...
    <p>
      Clicking on Deactivated Users from the Admin Dashboard brings up a list of
      all deactivated users, with the option to reactivate the user profile.
      This will restore their permissions and original email address.
    </p>
