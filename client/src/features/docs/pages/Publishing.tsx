...
export const Publishing = () => (
  <DocBody>
    ...
    <p>
      Publishing is the process by which you can make any item accessible to the
      greater precisionFDA community. By using publishing, you can contribute
      reference data, software, results, or pretty much anything else, so that
      others can use them. The process of publishing changes the access
      permissions of an item from 'private' to 'public'. <strong>NOTE:</strong>{' '}
      Currently there is no way to "unpublish" an item (other than deleting it).
    </p>
    <p>
      Since publishing an item means that others will be able to access it, it's
      very important to understand the exact implications, to ensure that you
      make a conscious decision. The following table summarizes what it means to
      publish items of a given type:
    </p>
    <DocTable>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            Users will be able to run the app, and view the app's specification
            (input and output spec, VM environment details and app shell
            script).
          </td>
        </tr>
        <tr>
          <td>App asset</td>
          <td>
            The asset will appear in everyone's list of available assets. Users
            will be able to use the asset when making apps, view the asset's
            information (readme, and list of files), and download the asset.
          </td>
        </tr>
        <tr>
          <td>Comparison</td>
          <td>
            ...
            value), visualize the comparison, and download any of the comparison
            output files.
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            will be able to download the file or use it as input in their jobs.
          </td>
          <td>
            The file will appear in everyone's list of available files. Users
            will be able to download the file or use it as input in their jobs.
        ...
        <tr>
          <td>Note</td>
          <td>
            The note will appear in everyone's list of notes. Users will be able
            to read the note.
          </td>
        </tr>
      </tbody>
    ...
    <p>
      ...
      related items, those that are already public are shown as such and cannot
      be selected for publication. Those that are owned by you and can be
      published have a checkbox next to them. Tick that checkbox to enable
      publication. If the item you tick contains additional related items, those
      will be presented as well, etc. <strong>IMPORTANT:</strong> For items with
      a long chain of dependencies (such as a file produced by a series of
      consecutive jobs) this interface can get very deep. For that reason, prior
      to publishing any item,{' '}
      <u>
    ...
    <p>
      ...
      you would like to also publish its attachments. If you publish a file, it
      will offer to publish the job it was generated from, and the app that was
      used for that job, etc. We recommend publishing related items, to ensure
      that others have access to complete information and are able to reproduce
      your work. To better understand the implications of NOT publishing a
      related item and instead keeping it private, consult the following table:
    </p>
    <DocTable>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            will not be able to access its private app asset. As a result, when
            users fork the app, the private asset will not be included in the
            list of assets, essentially leading to a nonfunctional fork.
            ...
            code that is not open-source and whose executables you don't want to
            openly distribute.
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            provide for a copy of the comparison inputs (since they simply split
            the input in terms of true positives and false positives, etc.)
          </td>
        </tr>
        <tr>
          <td>File</td>
          ...
          <td>
            ...
            be able to see further information as to how the file got generated.
            <br />
            <br />
        ...
        <tr>
          ...
          <td>
            ...
            its name (i.e. app-Bk7jzXj02902969jx5q2pfzq) and will not be able to
            reproduce the work, since they can't run that app.
          </td>
        </tr>
      </tbody>
    </DocTable>
