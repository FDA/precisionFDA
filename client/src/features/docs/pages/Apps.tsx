...
import { DocBody, DocTable, DocsTip, VideoWrapper } from '../styles'
...
export const Apps = () => (
  <DocBody>
    ...
    <p>The virtual machine runs Ubuntu Linux 14.04 or 16.04 depending on selection with certain preinstalled <strong>Ubuntu packages</strong>. The app author, however, can select additional Ubuntu packages to be included with an app.</p>
    ...
    <img width="100%" src={exportScreenshot} alt="Export an app to Docker Container, CWL Tool or WDL Task on Relevant Apps page" />
    ...
    <pre>
      $ mkdir url_fetcher<br />
      $ tar -xvzf url_fetcher.tar.gz -C url_fetcher<br />
      x README.md<br />
      x url_fetcher.wdl<br />
      x Dockerfile<br />
      $ cd url_fetcher<br />
      $ cat README.md<br />
      #url_fetcher<br /><br />

      To execute this app locally, please ensure you have Docker (get.docker.com), Cromwell (https://github.com/broadinstitute/cromwell) and WDLTool (https://github.com/broadinstitute/wdltool) and run:<br /><br />

      ```<br />
      docker build . -t url_fetcher<br />
  java -jar /path/to/wdltool.jar inputs url_fetcher.wdl {'>'} inputs.json<br />
      java -jar /path/to/cromwell.jar run url_fetcher.wdl -i inputs.json<br />
      ```<br /><br />
