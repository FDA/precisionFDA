  ...
  <DocRow>
    <DocBody>
      ...
      <p>
        ...
        Most apps on precisionFDA are non-interactive: you provide inputs, the
        app follows a set script, and creates outputs if it finishes
        successfully. Workstations are interactive; they create an environment
        where the user may enter any command they choose.
      </p>
      ...
      <p>
        ...
        server graphical interface. The Jupyter interface supports running
        Python or R notebooks, as well as a built-in terminal.
      </p>
      ...
      <p>
        ...
        cloud environment. You can interact with these files using{' '}
        <code>dx</code> commands:
      </p>
      ...
      <p>
        ...
        and can be seen as a "save point". The snapshot action creates a tarball
        that contains all modified files, which is placed in a user's
      ...
      <p>
        ...
        snapshot file will appear in your private Files area. You can recognize
        these files, as they will end in ".snapshot". This file may be an
        optional input to a new Workstation execution.
      </p>
      <p>
        <i>
          NOTE: In order to run the snapshot generation command, Python2.7 must
          be included in the $PYTHONPATH variable. Installing Python managers,
          such as Conda/BioConda, may alter this path. If you see a failure to
          generate the snapshot, check to see if this path has been changed by
          running
      ...
      <p>
        ...
        no longer accessible! Make sure to upload your work, or take a snapshot
        of the worker, before terminating.
      </p>
    </DocBody>
    <RightSide>
      <PageMap>
        <li>
          <a href="#workstation-types" data-turbolinks="false">Workstation Types</a>
        </li>
        <li>
          <a href="#workstation-access" data-turbolinks="false">Access to Workstations</a>
        </li>
        <li>
          <a href="#workstation-launching" data-turbolinks="false">Launching a Workstation</a>
        </li>
        <li>
        ...
        <li>
          <a href="#workstation-terminating" data-turbolinks="false">Terminating Workstations</a>
        </li>
      </PageMap>
    </RightSide>
  </DocRow>
