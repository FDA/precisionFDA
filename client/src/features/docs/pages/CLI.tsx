...
import { ButtonRow, DocBody, DocsTip } from '../styles'
...
export const CLI = () => (
  <DocBody>
    ...
    <p>
      ...
      files or assets to your home area or to a Space where you have access. You
      can also integrate this into your scripts to automate your workflow and do
    ...
    <ButtonRow>
      <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-linux-2.1.2.tar.gz" target="_blank" rel="noreferrer">
        <ButtonSolidBlue><DownloadIcon/> Linux</ButtonSolidBlue>
      </a>
      <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-darwin-2.1.2.tar.gz" target="_blank" rel="noreferrer">
        <ButtonSolidBlue><DownloadIcon/> Mac OS X</ButtonSolidBlue>
      </a>
      <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-windows-2.1.2.zip" target="_blank" rel="noreferrer">
        <ButtonSolidBlue><DownloadIcon/> Windows</ButtonSolidBlue>
      </a>
    </ButtonRow>
    ...
    <p>
      Visit the <a href="<%= new_asset_path %>">Create Assets</a> page and click
      on Generate Authorization Key button to generate a key that you will need
      when using the CLI.
    </p>
    ...
    <p>
      ...
      where you have access. Currently you can only upload single files and not
      a folder, but you can embed the command in a script to do batch uploads.
    </p>
    <p>
    ...
    <DocsTip>
      ...
      <strong>TIP:</strong> To find FOLDER_ID, inspect the URL when browsing the
    ...
    <DocsTip>
      ...
      Space.
      <br />
      For example, in the URL "https://precision.fda.gov/spaces/225/files", the
      Space ID is 225.
    </DocsTip>
    ...
    <p>
      ...
      contents and a readme file, and run the following command with the desired
      asset name (must end in .tar or .tar.gz)
    </p>
    <p>
      <code>
        {
