...
export const ChallengeWorkbench = () => (
  <DocBody>
    ...
    <ul>
      ...
      <li>
        Description: a short summary of the challenge that will appear under the
        title in the challenge banner.
      </li>
      <li>
        Scoring App User: the precisionFDA account of the user who will develop
        the scoring application. This can be your own username or the name of
        any user on the platform. You select the username from a dropdown list.
        You can jump to a specific user by typing the first few characters of
        their name.
      </li>
      <li>
        You can set a challenge start and end date and time, based on your local
        timezone.
      </li>
      <li>
      ...
      <li>Status: one of setup, open, results_announced, paused, archived.</li>
    </ul>
    ...
    <p>
      ...
      phase, only admins and challenge admins will be able to see the challenge;
      other users will see no trace of the challenge. Any of the fields may be
      changed by going to the “Settings” of the challenge (which is only
      available to admins).
    </p>
    ...
    <p>
      At any point while the challenge is open, an admin can place the challenge
      into the “paused” state. The challenge is still open, but the ability to
      submit is temporarily disabled.
    </p>
    ...
    <p>
      Finally, the challenge can be put into the "archived” phase, at which time
      the large challenge banner is removed. The challenge is still visible on a
      card under the “Previous PrecisionFDA Challenges” section of the
      Challenges page.
    </p>
    ...
    <p>
      Modifying the challenge page settings, phases, and card can all be done by
      clicking the “Settings” button nearby the challenge on the challenge site.
      Again, this feature is only accessible to admins on the site.
    </p>
    ...
    <p>
      From here, there will be tabs to edit the challenges information, results,
      and resources. The results page won't be shown until a later time.
    </p>
    <p>
      To add images to your challenge pages, you will need to add the image as a
      resource. From the "Resources" tab, you can upload image files. After an
      image file is uploaded, a link will be generated that you can use to add
      that image to your challenge pages. The image processing may take a couple
      of minutes.
    </p>

    <img width="100%" src={edit2} alt="Available Resources for archived Challenge" />
    ...
    <p>
      ...
      should be carefully crafted to prevent leaking any information and attempt
      proper validation of all submissions.
    </p>
    <p>
      ...
      metrics that can be used to summarizing the results, often in the form of
      integers (ints) or floating point numbers (floats), and possibly a text
      report containing more detailed information about the results.
    </p>
    <p>
      ...
      submission was successful. If the challenge evaluation app fails, then the
      user will be able to look at the log file of that failure. For this
    ...
    <p>
      ...
      party tools to validate data (VCF validation is already performed by many
      tools). Other times you will have to write some custom code to do so
      (validating the file is in CSV format, for example). Ideally, you have
      some examples of submissions that should succeed and fail validation for
      testing purposes.
    </p>
    <p>
      The second part of your app will actually calculate the output metrics and
      evaluate the submission results. This can vary quite a bit depending on
      the nature of the challenge. Again, sometimes there are tools that can
      help (VCF comparisons), and other times you will have to write the code
      yourself. The metrics you care about should be saved into variables for
      output.
    </p>
    <p>
    ...
    <p>
      ...
      Challenge” button and click the name of your challenge. At this point, the
      app becomes the evaluator app for your challenge.
    </p>

    <h2 id="challenge-open">Opening a Challenge</h2>

    <p>
      Once the challenge intro page and challenge evaluation app are ready, you
      can transition the challenge to “open” through the challenge settings. At
