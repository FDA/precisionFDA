...
export const OrganizationsDeprecation = () => (
  <DocBody>
    ...
    <p>
      To improve the precisionFDA user experience, we have decided to deprecate
      the Organization (or "Org") functionality of the site. Specifically, we
      will be making the following changes:
    </p>
    <ul>
      <li>
      ...
      <li>New users will not be asked for their organizational affiliation.</li>
      <li>
        No new organizations will be created, and new users will no longer have
        the option of becoming an organization administrator when they sign up.
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        Current org administrators will continue to have the ability to view the
        org members and provision new users via their Profile page.
      </li>
      <li>
    ...
    <p>
      These changes will be rolled out over the next several weeks. We hope that
      these changes will improve the experience for all precisionFDA users.
      Please contact{' '}
