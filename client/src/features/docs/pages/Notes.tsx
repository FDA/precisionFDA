  ...
  <DocRow>
    <DocBody>
      ...
      <p>
        ...
        comparisons, and apps&mdash;which you can also attach to the
        note&mdash;to prove a certain point or to document a procedure. You can
        read what others have reported and access their attachments to take a
        closer look at their work or even reproduce it on your own.
      </p>
      ...
      <p>
        ...
        to...". A list of all the notes authored by you will pop up. Select one
        or more notes and click "Attach". If you attach a private item to a
        public note, the system <strong>does not</strong> adjust any
        permissions; you need to separately publish that item so that others can
        access it when they read your note.
      </p>
      ...
      <p>
        ...
        are contributing these items and what you expect community members to do
        with them. This way, when someone stumbles upon a published item of
      ...
      <DocsTip>
        ...
        For example, you can create a "scrapbook" note and while browsing the
        rest of the website, if you come across an interesting item, attach it
        to your scrapbook.
      </DocsTip>

      <p>
        Tell us how you'd like this feature to evolve. Are you interested in the
        ability to comment on other people's notes? Would you care to
    ...
    <RightSide>
      <PageMap>
        <li>
          <a href="#notes-edit" data-turbolinks="false">Editing notes</a>
        </li>
        <li>
          <a href="#notes-ideas" data-turbolinks="false">Ideas for using notes</a>
        </li>
      </PageMap>
    </RightSide>
  </DocRow>
