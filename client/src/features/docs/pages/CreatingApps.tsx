...
export const CreatingApps = () => (
  <DocRow>
    <DocBody>
      ...
      <p>
        To create a new app, click "Create App" in the Apps page. The following
        section walks you through important concepts of app development.
      </p>
      <DocsTip>
        <span className="fa fa-lightbulb-o" aria-hidden="true" />{' '}
        <strong>TIP:</strong> Want to learn by example? Simply choose any of the
        public apps in precisionFDA and click "Fork". This will load up the app
        editor, where you can take a look at the internals of the app and see
        what it is comprised of. You can then hit the Back button in your web
        browser -- unless of course you truly want to fork the app and make a
        private copy with which you can experiment, in which case click the new
      ...
      <p>
        ...
        cannot author two distinct apps with the same name). This restriction is
        only per-user, meaning that you can still create an app with the same
        name as someone else's app. In fact, the system encourages you to use
        someone else's app as a starting point and make further tweaks and save
        it as your own app (a process called "<strong>forking</strong>" an app).
        This model was inspired from the model of GitHub repositories.
      </p>
      ...
      <p>
        ...
        they need from the user, and what outputs they are expected to generate.
        Note that an "input" is anything that needs to be received from the user
        and which can potentially vary between executions. These can be not only
        input files but also numerical or boolean values, and strings. In that
        sense, the "inputs" can be used both for receiving data to operate on as
        well as receiving configuration parameters. Each input field has the
      ...
      <DocTable>
        ...
        <tbody>
          <tr>
            <td>Class</td>
            <td>
              The kind of input. There are exactly five classes supported: file,
          ...
          <tr>
            <td>Default value</td>
            <td>
              A default value that this field will be pre-filled with when users
              launch the app. (You are not required to provide defaults; do so
              only if you need to guide users in choosing the right values.)
            </td>
          </tr>
          <tr>
            <td>Choices</td>
            <td>
              A set of comma-separated values denoting the only permitted values
              for this field. If such choices are provided, the user must choose
              one of them using a drop-down menu and can't write in their own
              value.
            </td>
          </tr>
          <tr>
            <td>Optional?</td>
            <td>
              Whether this field is optional or required. When launching an app,
              users must fill all required fields before they can continue.
            </td>
          </tr>
        </tbody>
      </DocTable>
      ...
      <p>
        The output specification is similar to the input specification (but with
        no default values). When creating an app, you specify what kind of
        inputs your app is expected to create, and define names and labels for
        them. When your script runs, it is responsible for generating the
        respective outputs. If an output is marked as optional, your script is
        not required to produce it. See the{' '}
        <a href="#app-script">app shell script</a> section for more information.
      </p>
      <DocCallout>
      ...
      <p>
        ...
        specific environment. When authoring an app, you have the opportunity to
        configure the environment according to your needs, using the "VM
        Environment" tab.
      </p>
      <p>
        By default, apps do not have access to the Internet. Removing Internet
        access ensures that apps cannot communicate with the outside world over
        the Internet -- this increases user comfort and lowers the barriers for
        users to try out apps. If your app requires Internet access (for
        example, to communicate with a third-party database over the Internet,
        to fetch files from URLs, or to fetch and install external software at
        runtime), you can enable it in this tab.
      </p>
      <p>
        The default instance type denotes the particular hardware configuration
        that the app will run on. Each instance type comes with a specific
        amount of memory, number of CPU cores, and hard disk storage. See the
        section on <a href="#app-instance-types">available instance types</a>{' '}
        below for more information. Although you can choose a default one in the
        "VM Environment" tab, users can still override the default choice when
        launching the app. This is useful if you have a single app that can work
        for both small inputs (such as an exome) and large inputs (such as a
        whole genome).
      </p>
      <DocsTip>
        <span className="fa fa-lightbulb-o" aria-hidden="true" />{' '}
        ...
        the app's Readme to guide users as to how to adjust it when running your
        app with larger inputs. Jobs consume energy depending on the instance
        type used, so your pipeline may be wasteful if it does not use its
        default instance type efficiently.
      </DocsTip>
      <p>
      ...
      <p>
        ...
        recommend adding the "openjdk-7-jre-headless" package. If you are unsure
        as to what a certain package is called, you can use the{' '}
        <a href="http://packages.ubuntu.com">packages.ubuntu.com</a> website to
        locate packages (make sure to select the "trusty" distribution in the
        search form, as that is the codename for Ubuntu 14.04 or "xenial" for
        Ubuntu 16.04). Note that, specifically for Java 8, we support additional
        packages (such as "openjdk-8-jre-headless") which are not listed on the
      ...
      <p>
        ...
        libraries, reference genome files or pretty much any other static files
        required for your execution, you can use <b>App assets</b>. Assets are
        tarballs that are uncompressed in the root folder of the virtual machine
        right before running your app script. The{' '}
        <a href="#app-assets">App assets</a> section discusses in detail how to
        create, manage, and select assets for your app.
      </p>
      <p>
        The shell script of an app contains the shell code that will run inside
        the virtual machine. The script runs as root. During the script
      ...
      <DocTable>
        ...
        <tbody>
          ...
          <tr>
            <td>3</td>
            <td>
              Your app's assets are fetched and uncompressed in the root folder.
            </td>
          </tr>
          <tr>
            <td>4</td>
      ...
      <p>
        ...
        reference genomes and index files) or pretty much anything else that is
        required for an app to run.
      </p>
      <p>
        Just like regular files, app assets can be either private or publicly
        contributed to the precisionFDA community. Your app can choose among any
        accessible assets (whether private or public).
      </p>
      <DocsTip>
        <span className="fa fa-lightbulb-o" aria-hidden="true" />{' '}
        ...
        the app but their fork won't include the private assets. This may be an
        option of choice if you want to allow people to try out something
        without giving them access to the code. For more information consult the
        second table in the <Link to="/docs/publishing">Publishing</Link>{' '}
        section.
      </DocsTip>
      <p>
      ...
      <p>
        When editing an app, in the "VM Environment" tab, you will see a list of
        assets that have been selected for inclusion in the app's virtual
      ...
      <p>
        The selector lists all available assets on the left hand side. Clicking
        on the name of an asset, or on the checkbox next to it, will select that
        asset for inclusion. Clicking on the whitespace surrounding the asset
        name, or on the right-pointing arrow next to the asset name will display
        information about the asset (but not toggle the selection).{' '}
        <u>Each asset comes with documentation</u>, which is meant to describe
        what is the asset and how it can be used. In addition, the system
        displays a list of all files that are found inside the tarball.
      </p>
      <p>
        We understand that asset names may not always be indicative of their
        contents; for example, many people would recognize <code>tabix</code> as
        the executable that indexes VCF files, but fewer people would recognize{' '}
        <code>htslib</code> as the asset containing that executable. For this
        reason, the precisionFDA system includes a feature that allows you to
        search filenames across all assets. In the asset selector, type a search
        keyword (such as <code>tabix</code>) in the upper left corner. The asset
        list will be filtered to show you assets which include that file (such
        as <code>htslib</code>), as well as assets whose name starts with that
        prefix.
      </p>
      <p>
        To upload your own assets, or to perform more detailed asset management
        (such as download an asset to take a look at it yourself, or delete an
        asset you've previously uploaded) click "Manage your assets", from
        either the asset selector or the "VM Environment" tab (or "Manage
        Assets" from the Apps listing page). You will be taken to a page listing
        all the precisionFDA assets (your private ones, and all public ones).
        Click on an asset's name to see asset details, and to perform actions
        such as download, delete, or edit its readme. Click "Create Assets" at
        the top to be presented with instructions on how to upload your own
        assets. The next section discusses the process in detail.
      </p>

      <h2 id="app-own-assets">
        Your own assets
      </h2>
      ...
      <p>
        Since the asset will be uncompressed in the root folder on the cloud, it
        is important for the tarball to contain the proper subfolders inside of
        it. If an asset tarball does not have any subfolders, then its files
        will be placed directly inside the root folder (i.e. in <code>/</code>),
      ...
      <p>
        ...
        under that folder will be readily accessible. For example, if your asset
        includes a file <code>/work/GenomeAnalysisTK.jar</code>, you can use it
        inside your script without any other folder designation, i.e. like this:{' '}
        <code>java -jar GenomeAnalysisTK.jar</code>.
      </p>
      <p>
        If you need to compile binaries for Ubuntu, or otherwise experiment with
        a Linux environment similar to the one that apps run on, download and
      ...
      <DocsTip>
        <span className="fa fa-lightbulb-o" aria-hidden="true" />{' '}
        <strong>TIP:</strong> From your host operating system (such as the OS X
        Terminal) you can SSH into the VM by typing{' '}
      ...
      <p>
        The following table summarizes ways in which you can use the VirtualBox
        machine to prepare content for inclusion in your fake root:
      </p>
      <DocTable>
        <thead>
          <tr>
      ...
      <p>
        ...
        . Below is an example of the Readme file included with the htslib-1.2.1
        public asset: (note the extra two spaces after tabix-1.2.1.html -- this
        is how you introduce line breaks in markdown)
      </p>
      <pre>
      ...
      <p>
        Download the precisionFDA uploader by clicking the respective button for
        your operating system (os) and architecture (arch) in the "Create
      ...
      <p>
        ...
        . This command will archive the contents of the fake root into the named
        tarball, and upload it to precisionFDA along with the contents of the
        readme file. The tarball name must end in either <code>.tar.gz</code> or{' '}
        <code>.tar</code> (in which latter case it will not be compressed).
      </p>
      <DocsTip>
        <span className="fa fa-lightbulb-o" aria-hidden="true" />{' '}
      ...
      <p>
        When creating an app, the "Script" tab provides you with an editor where
        you can write the shell script that will be executed. The script will
        run as root, inside the <code>/work</code> folder (which is also set as
        the home directory during execution). The script is <code>source</code>
      ...
      <ul>
        <li>
          ...
          shell variable with the same name. Its value is set to whatever value
          the user provided for that input (or empty, if that input is optional
        ...
        <li>
          ...
          input field <code>intervals</code>, the system will download the file
          into <code>/work/in/intervals/trusight.bed</code>. In addition, the
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  without its second suffix, i.e. without ".tar.gz", ".vcf.gz",
                  or ".fastq.gz").
                </td>
              </tr>
            </tbody>
      ...
      <DocCallout>
        ...
        <p>
          The system defines the prefix variable because it can be often used to
          name results. In our example app, we can name the padded intervals{' '}
          <code>"$intervals_prefix".padded.bed</code>.
        </p>
      </DocCallout>
      <p>
        Your script needs to communicate back to the system its outputs. This is
        handled via a helper utility called <code>emit</code>. Use it as
        follows:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        the most popular shell interpreter in Linux distributions, and also used
        to power the OS X Terminal app. In most systems you can reach the bash
        manual by typing <code>man bash</code>.
      </p>
      <p>
      ...
      <DocTable>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              The script will halt as soon as any command fails in a pipeline of
              commands, i.e. <code>cmd1 | cmd2 | cmd3</code>.
            </td>
          </tr>
        </tbody>
      </DocTable>
      <DocsTip>
        ...
        Without pipefail, a failure in the first part (<code>zcat</code>) of the
        pipeline would not cause this command to fail, so your script would have
        continued running. However, this means that you must be careful to not
        include any commands which may return non-zero exit status in your
        script. For example,{' '}
        <code>grep chr1 some_file | wc -l &gt;chr1-counts.txt</code> would fail
        if there are no <code>chr1</code> entries in <code>some_file</code>,
        instead of outputting the number <code>0</code> to{' '}
        <code>chr1-counts.txt</code> (because when grep does not find something,
        it fails). If you are worried about this behavior, you can undo the
        option via <code>set +o pipefail</code>.
      </DocsTip>
      <p>
        ...
        <code>$file_path</code>. This will allow you to handle corner cases such
        as spaces included in the filename.
      </p>
      ...
      <p>
        ...
        editor and initialize it with the specification of the original app. You
        can make any changes and then save them into a new private app owned by
        you. (Unlike GitHub, precisionFDA does not keep track of forks, and the
        operation is always private).
      </p>
      <p>
      ...
      <p>
        On precisionFDA, there are two methods for building apps. You may create
        apps on precisionFDA using the UI, as is described in{' '}
        <Link
      ...
      <div className="bs-docs-section">
        ...
        <ul>
          <li>
            ...
            parameters for your app without needing to click through multiple UI
            screens.
          </li>
          <li>
            Importing an app via a CWL or WDL script is an easy way to make use
            of public Docker images in an application format on precisionFDA.
          </li>
          <li>
      ...
      <h2 id="cwl-script-structure">
        How to Structure a CWL Script
      </h2>

      <p>
        In order to successfully import as an app in precisionFDA, a CWL script
        must include several key features.
      </p>
      <p>
        First, the inputs and outputs specified in the CWL script must be one of
        the five data types used on precisionFDA -{' '}
        ...
        specifies an array as an input or output will not import successfully as
        an app.
      </p>
      <p>
        ...
        present, the script will not import successfully as an app, because the
        app will not see a valid set of commands to run.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Information in the <strong>doc</strong> field will be included in the
          Readme of the app. You may provide details about how your app
      ...
      <p>
        When you click on this button, you'll be prompted to select a local file
        from your computer with a .cwl extension. There is also a textbox to
        type in the CWL script if you don't have the file ready.
      </p>
      ...
      <p>
        ...
        sure that all components are present in the CWL script; you may consult
        the example CWL script in this help.
      </p>
      ...
      <p>
        After you click Ok, you can see all the inputs and outputs specified in
        the CWL file are shown as inputs and outputs of your app.
      </p>
      ...
      <p>
        First, the inputs and outputs specified in the WDL script must be one of
        the five data types used on precisionFDA - file, string, float, integer,
        or Boolean. Arrays are not supported as a data type on precisionFDA, and
        any WDL script that specifies an array as an input or output will not
        import successfully as an app.
      </p>
      <p>
      ...
      <p>
        ...
        specify a public Docker image that will be automatically pulled and used
        to execute the commands of the app.
      </p>
      <p>
      ...
      <p>
        When you click on this button, you'll be prompted to select a local file
        from your computer with a .wdl extension. There is also a textbox to
        type in the WDL script if you don't have the file ready.
      </p>
      ...
      <p>
        After you click Ok, you can see all the inputs and outputs specified in
        the WDL file are shown as inputs and outputs of your app.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            Click on "Edit" to open the editing page of the app, scroll down to
            the script that creates the inputs.json file.
          </p>
          <img
            width="100%"
            src={wdljsoninputs}
          ...
          />
          <p>
            Modify the script for the optional inputs as following, make sure to
            change the workflow name (run_app) and the app name (app) into your
            workflow name and your app name in this script.
          </p>
          <img
            width="100%"
            src={wdljsoninputs2}
    ...
    <RightSide>
      <PageMap>
        <li>
          <a href="#app-name" data-turbolinks="false">App naming conventions</a>
        </li>
        <li>
          <a href="#app-io" data-turbolinks="false">Input and Output spec</a>
        </li>
        <li>
          <a href="#app-vm-env" data-turbolinks="false">VM Environment</a>
        </li>
        <li>
        ...
        <li>
          <a href="#app-assets" data-turbolinks="false">App assets</a>
        </li>
        <li>
          <a href="#app-own-assets" data-turbolinks="false">Your own assets</a>
        </li>
        <li>
          <a href="#app-script" data-turbolinks="false">App script</a>
        </li>
        <li>
          <a href="#app-bash" data-turbolinks="false">Bash tips</a>
        </li>
        <li>
          <a href="#app-fork" data-turbolinks="false">Forking an app</a>
        </li>
        <li>
          <a href="#app-import" data-turbolinks="false">App Import</a>
        </li>
        <li>
          <a href="#app-import-reasons" data-turbolinks="false">Why Use App Import?</a>
        </li>
        <li>
        ...
        <li>
          <a href="#cwl-import" data-turbolinks="false">How to Import a CWL File</a>
        </li>
        <li>
        ...
        <li>
          <a href="#wdl-import" data-turbolinks="false">How to Import a WDL File</a>
        </li>
        <li>
