...
export const ReviewSpaces = () => (
  <DocBody>
    ...
    <p>
      ...
      designed to let two collaborating groups work cooperatively on a project.
    </p>
    ...
    <p>
      ...
      <strong>The reviewer</strong> lead should be either yourself or the person
      leading the review, as their account will have permission to complete the
      space setup process.
      <strong>The sponsor org</strong> should be the organization whose work you
      are reviewing. You may also choose to load a template space that was used
      for app verification, if you choose to do so.
    </p>
    ...
    <h2 id="review-space-confidential">Using the Confidential Review Space</h2>

    <p>
      Once the review space has been accepted by both groups, it will activate,
      and both the review lead and the sponsor org administrator may log into
      their <strong>confidential spaces</strong>. From here, they may add files,
      apps, jobs and notes, and they may add other members to the space.
    </p>
    ...
    <p>
      ...
      <strong>Move data to space</strong> button located in the upper right hand
      corner. To invite other users to a space, you can click on the{' '}
    ...
    <p>
      <strong>The cooperative space</strong> appears very similar to the private
      space, and includes all of the same features. You can add files, notes,
      assets, apps and jobs, and run apps in this space. Here, however, you’ll
      note that the members of both spaces have access - any data objects you
      add to this space can be accessed by both parties, so make sure you only
      add objects that you wish to share!
    </p>
    <p>
    ...
    <p>
      ...
      space to the shared, cooperative space, you may do so by going to the page
      of that data object.
    </p>
    ...
    <p>
      If this data object does not currently exist in the cooperative space, you
      will see a green button labeled <strong>Copy to Cooperative</strong>. When
      you click this button, a copy of this data object will be created in the
      shared cooperative space. Once again, note that this action cannot be
      undone, so you will receive an <strong>Are you sure?</strong> prompt.
    </p>
    ...
    <p>
      ...
      and review spaces. There are two methods for moving a workflow to a space:
      1) publishing the workflow from the “Workflows” screen, or 2) moving the
      workflow to a space from the “Spaces” screen.
    </p>
    <p>
      Workflows cannot be removed from a space once added, so take caution when
      adding a workflow to a space. Additionally, once a workflow has been added
      to one space, it cannot be added to any other space. However, a workflow
      can be “forked” to create a new copy of the workflow that can optionally
      be modified and then added to another space if desired.
    </p>
    ...
    <p>
      ...
      would like to publish, and then select the ‘Publish’ button. An example is
      shown below.
    </p>
    ...
    <p>
      ...
      If, for example, a component app was privately built by you, then you must
      check “share” to include all of the resources contained within that app.
      Alternatively, if the component object in your workflow is public, it will
      be automatically shared to the space. See the example case below.
    </p>
    ...
    <p>
      After you’ve decided to share all of the data objects within the workflow,
      you may press 'Share select objects to “&lt;space name&gt;”'. The workflow
      will then be published to that space. Only public objects can be shared
      with cooperative spaces. Both public and private objects can be shared to
      confidential spaces.
    </p>
    ...
    <p>
      After the workflow has been added to the space, it is now runnable in the
      space, and can be accessed under the “Workflows” tab on the left side.
    </p>
