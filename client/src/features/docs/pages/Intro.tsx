...
export const Intro = () => (
  <DocBody>
    ...
    <p>
      We are excited to have you on board, and have prepared this guide to help
      you make the most out of the precisionFDA platform. We hope that this
      guide will answer many of your questions and provide you with additional
      insights to further empower you to use the system. If your favorite topic
      is not covered, please don't hesitate to{' '}
    ...
    <DocsTip>
      ...
      encourage you to{' '}
      <a href="mailto:precisionfda@fda.hhs.gov">report feedback</a> and tell us
