...
import {
  homeExecutionsIsFetchingSelector,
  homeExecutionsIsCheckedAllSelector,
  homeExecutionsIsExpandedAllSelector,
  homeExecutionsFiltersSelector,
...
const HomeExecutionsTable = (props) => {
...
HomeExecutionsTable.defaultProps = {
  executions: [],
  sortHandler: () => { },
  filters: {},
}
...
const mapStateToProps = (state) => ({
  isFetching: homeExecutionsIsFetchingSelector(state),
  isCheckedAll: homeExecutionsIsCheckedAllSelector(state),
  isExpandedAll: homeExecutionsIsExpandedAllSelector(state),
  filters: homeExecutionsFiltersSelector(state),
})

const mapDispatchToProps = (dispatch) => ({
  expandExecution: (key) => dispatch(expandExecution(key)),
  expandAllExecutions: () => dispatch(expandAllExecutions()),
  toggleExecutionCheckbox: (key) => dispatch(toggleExecutionCheckbox(key)),
  toggleAllExecutionsCheckboxes: () => dispatch(toggleAllExecutionsCheckboxes()),
})

export default connect(mapStateToProps, mapDispatchToProps)(HomeExecutionsTable)
