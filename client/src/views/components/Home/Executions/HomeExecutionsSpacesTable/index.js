...
import {
  homeExecutionsSpacesIsFetchingSelector,
  homeExecutionsSpacesIsCheckedAllSelector,
  homeExecutionsSpacesIsExpandedAllSelector,
  homeExecutionsSpacesFiltersSelector,
...
const HomeExecutionsSpacesTable = (props) => {
...
const WorkflowRow = ({ execution, expandExecution, toggleExecutionCheckbox }) => {
  ...
  return (
    <tr>
      ...
      <td>
        <Link to={`${links.space}/jobs`} target='_blank'>
...
HomeExecutionsSpacesTable.propTypes = {
...
HomeExecutionsSpacesTable.defaultProps = {
  executions: [],
  sortHandler: () => { },
  filters: {},
}
...
const mapStateToProps = (state) => ({
  isFetching: homeExecutionsSpacesIsFetchingSelector(state),
  isCheckedAll: homeExecutionsSpacesIsCheckedAllSelector(state),
  isExpandedAll: homeExecutionsSpacesIsExpandedAllSelector(state),
  filters: homeExecutionsSpacesFiltersSelector(state),
})

const mapDispatchToProps = (dispatch) => ({
  expandExecution: (key) => dispatch(expandExecutionSpaces(key)),
  expandAllExecutions: () => dispatch(expandAllExecutionsSpaces()),
  toggleExecutionCheckbox: (key) => dispatch(toggleExecutionSpacesCheckbox(key)),
  toggleAllExecutionsCheckboxes: () => dispatch(toggleAllExecutionsSpacesCheckboxes()),
})

export default connect(mapStateToProps, mapDispatchToProps)(HomeExecutionsSpacesTable)

export {
  HomeExecutionsSpacesTable,
}
