...
import {
  homeAssetsFeaturedIsFetchingSelector,
  homeAssetsFeaturedIsCheckedAllSelector,
  homeAssetsFeaturedFiltersSelector,
...
const HomeAssetsFeaturedTable = ({ assets, isFetching, isCheckedAll, toggleAllAssetsCheckboxes, toggleAssetCheckbox, filters, handleFilterValue }) => {
...
HomeAssetsFeaturedTable.propTypes = {
...
HomeAssetsFeaturedTable.defaultProps = {
  assets: [],
  filters: {},
}
...
const mapStateToProps = (state) => ({
  isFetching: homeAssetsFeaturedIsFetchingSelector(state),
  isCheckedAll: homeAssetsFeaturedIsCheckedAllSelector(state),
  filters: homeAssetsFeaturedFiltersSelector(state),
})

const mapDispatchToProps = (dispatch) => ({
  toggleAllAssetsCheckboxes: () => dispatch(toggleAllAssetsFeaturedCheckboxes()),
  toggleAssetCheckbox: (id) => dispatch(toggleAssetFeaturedCheckbox(id)),
})

export default connect(mapStateToProps, mapDispatchToProps)(HomeAssetsFeaturedTable)

export {
  HomeAssetsFeaturedTable,
}
