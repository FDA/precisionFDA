...
import {
  homeAssetsSpacesIsFetchingSelector,
  homeAssetsSpacesIsCheckedAllSelector,
  homeAssetsSpacesFiltersSelector,
...
const HomeAssetsSpacesTable = ({ assets, isFetching, isCheckedAll, toggleAllAssetsCheckboxes, toggleAssetCheckbox, filters, handleFilterValue }) => {
...
const Row = ({ asset, toggleAssetCheckbox }) => {
  ...
  return (
    <tr>
      ...
      <td>
        <Link target="_blank" to={`${asset.links.space}/apps`}>
...
HomeAssetsSpacesTable.propTypes = {
...
HomeAssetsSpacesTable.defaultProps = {
  assets: [],
  filters: {},
}
...
const mapStateToProps = (state) => ({
  isFetching: homeAssetsSpacesIsFetchingSelector(state),
  isCheckedAll: homeAssetsSpacesIsCheckedAllSelector(state),
  filters: homeAssetsSpacesFiltersSelector(state),
})

const mapDispatchToProps = (dispatch) => ({
  toggleAllAssetsCheckboxes: () => dispatch(toggleAllAssetsSpacesCheckboxes()),
  toggleAssetCheckbox: (id) => dispatch(toggleAssetSpacesCheckbox(id)),
})

export default connect(mapStateToProps, mapDispatchToProps)(HomeAssetsSpacesTable)

export {
  HomeAssetsSpacesTable,
}
