...
const getFiles = (spaceId, data) => backendCall(`/api/spaces/${spaceId}/files`, 'GET', data)
const getApps = (spaceId, data) => backendCall(`/api/spaces/${spaceId}/apps`, 'GET', data)
const getJobs = (spaceId, data) => backendCall(`/api/spaces/${spaceId}/jobs`, 'GET', data)
const getWorkflows = (spaceId, data) => backendCall(`/api/spaces/${spaceId}/workflows`, 'GET', data)
