...
describe AssetSerializer do
  ...
  describe "serialize" do
    it "common fields[name, type]" do
      asset_serialized = JSON.parse(asset_serializer.to_json)
    ...
    context "when user is not authenticated" do
      ...
      it "links[attach_to, add_file, add_folder]" do
        asset_serialized = JSON.parse(asset_serializer.to_json)
      ...
      it "links[user, track, download_list]" do
        asset_serialized = JSON.parse(asset_serializer.to_json)
