...
<!---  - What changes in the code behavior might affect other devs -->
<!---  - Note any refactoring that was done -->
<!---  - Note any code that's non-intuitive at first glace -->
...
<!--- Does your change affects other areas of the code, etc. -->
<!--- Screenshots before and after (if appropriate) -->
<!--- How QE should validate this -->
...
- [ ] My change mutates the database. Dev team should be made aware to weigh in on the proposed schema.
- [ ] My change adds or changes backend API requests or responses. Dev team should be made aware to assess possible regression in other areas of the app
- [ ] I have added the appropriate unit and integration tests
