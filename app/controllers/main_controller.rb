class MainController < ApplicationController
  ...
  def index
    ...
    if @context.logged_in_or_guest?
      ...
      files = UserFile.real_files.accessible_by_public.limit(10)
      comparisons = Comparison.accessible_by_public.limit(10)
      apps = App.accessible_by_public.limit(10)
      jobs = Job.accessible_by_public.limit(10)
      assets = Asset.accessible_by_public.limit(10)
