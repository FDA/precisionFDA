...
class Invitation < ActiveRecord::Base
  ...
  validates :singular, :research_intent, :clinical_intent, :giab_challenge_intent, inclusion: [true, false]
  ...
  store :extras, accessors: [ :req_reason, :req_data, :req_software, :research_intent, :clinical_intent, :giab_challenge_intent ], coder: JSON
