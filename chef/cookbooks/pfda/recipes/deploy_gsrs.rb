...
tomcat_install "gsrs" do
  ...
  tarball_uri 'https://archive.apache.org/dist/tomcat/tomcat-10/v10.1.18/bin/apache-tomcat-10.1.18.tar.gz' # By default it goes to http and this is causing build issues
  checksum_uri 'https://archive.apache.org/dist/tomcat/tomcat-10/v10.1.18/bin/apache-tomcat-10.1.18.tar.gz.sha512' # By default it goes to http and this is causing build issues
