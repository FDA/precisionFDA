...
const createSyncTask = async <T extends types.Task>(task: T, queue: Bull.Queue, dxid: string) => {
...
const createSyncOutputsTask = async (data: types.CheckStatusJob['payload'], user: UserCtx) => {
