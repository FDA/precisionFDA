...
func PrintLsSpacesHelp() int {
	...
	writeLine("   -protected", "Shows only protected spaces")
...
func PrintLsMembersHelp() int {
	...
	writeLine("  Flags:", "All flags listed below are OPTIONAL unless noted")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -space-id <ID>", "Lists members in the specified space (required)")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintLsDiscussionsHelp() int {
	...
	writeLine("  Usage:", "ls-discussions -space-id <SPACE_ID>\n")
	writeLine("  Examples:", "ls-discussions -space-id 27 [Lists all discussions in the specified space]\n")
	writeLine("  Flags:", "All flags listed below are OPTIONAL unless noted")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -space-id <ID>", "Lists discussions in the specified space (required)")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintDownloadHelp() int {
	...
	writeLine("   -r, -recursive", "Recursively downloads content of selected folder")
...
func PrintDescribeHelp() int {
	...
	writeLine("  ", "  ")
	writeLine("  For:", "Getting details about a given entity. Supported entities: app, dbcluster, discussion, file, folder, job, workflow.\n")
...
func PrintUploadAssetHelp() int {
	...
	writeLine("  Flags:", "All flags listed below are OPTIONAL unless noted")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -name <NAME>", "Asset name (.tar or .tar.gz) (required)")
	writeLine("   -root <PATH>", "Path to root folder (required)")
	writeLine("   -readme <PATH>", "Path to readme file (.txt or .md) (required)")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintCreateDiscussionHelp() int {
	...
	writeLine("  ", "create-discussion '{\"title\":\"My Title\", \"content\":\"See attached\", \"attachments\":{\"files\":[\"file-GbKF3qQ0Z0gqk80j1QF47K8j-1\"], \"apps\":[\"app-YZm95v85a4ZfgQB4JcAB4g0-1\"]}}' -space-id 12 [Creates discussion with attachments]\n")
	writeLine("  Arguments:", "")
...
func PrintEditDiscussionHelp() int {
	...
	writeLine("  ", "edit-discussion '{\"discussionId\":15, \"content\":\"See attached\", \"attachments\":{\"files\":[\"file-GbKF3qQ0Z0gqk80j1QF47K8j-1\"], \"apps\":[\"app-YZm95v85a4ZfgQB4JcAB4g0-1\"]}}' [Appends content with attachments to discussion]\n")
	writeLine("  Arguments:", "")
...
func PrintCreateReplyHelp() int {
	...
	writeLine("  ", "  ")
	writeLine("  For:", "Creating a new reply in a discussion or on an answer. Accepts JSON with exactly one of discussionId/answerId (required), replyType ('Answer'/'Comment'), content (required), and attachments (optional).\n")
	...
	writeLine("  ", "create-reply '{\"discussionId\":15, \"replyType\":\"Comment\", \"content\":\"Comment reply to discussion\"}' [Creates comment in discussion]")
	writeLine("  ", "create-reply '{\"answerId\":42, \"replyType\":\"Comment\", \"content\":\"Reply to answer\"}' [Comments on an answer]")
	writeLine("  ", "create-reply '{\"discussionId\":15, \"replyType\":\"Answer\", \"content\":\"See attached\", \"attachments\":{\"files\":[\"file-GbKF3qQ0Z0gqk80j1QF47K8j-1\"], \"apps\":[\"app-YZm95v85a4ZfgQB4JcAB4g0-1\"]}}' [Answer with attachments]\n")
	writeLine("  Arguments:", "")
	writeLine("   <JSON_BODY>", "JSON object with exactly one of discussionId/answerId (required), replyType, content (required), and attachments (optional)\n")
	writeLine("  Flags:", "All flags listed below are OPTIONAL")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintEditReplyHelp() int {
	...
	writeLine("  ", "  ")
	writeLine("  For:", "Appending content and/or attachments to a reply. Accepts JSON with replyId (required), content, and attachments.\n")
	writeLine("  Usage:", "edit-reply '<JSON_BODY>' [FLAG...]\n")
	writeLine("  Examples:", "edit-reply '{\"replyId\":25, \"content\":\"Additional content\"}' [Appends content to reply]")
	writeLine("  ", "edit-reply '{\"replyId\":25, \"content\":\"See attached\", \"attachments\":{\"files\":[\"file-GbKF3qQ0Z0gqk80j1QF47K8j-1\"], \"apps\":[\"app-YZm95v85a4ZfgQB4JcAB4g0-1\"]}}' [Appends content with attachments to reply]\n")
	writeLine("  Arguments:", "")
	writeLine("   <JSON_BODY>", "JSON object with replyId (required), content, and attachments\n")
	writeLine("  Flags:", "All flags listed below are OPTIONAL")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintRmDiscussionHelp() int {
	writer := tabwriter.NewWriter(os.Stdout, 0, 8, 1, '\t', tabwriter.AlignRight)
	writeLine := newLineWriter(writer)

	writeLine("  ", "  ")
	writeLine("  For:", "Deleting a discussion by its numeric ID. The discussion's replies and attachments are removed as well.\n")
	writeLine("  Usage:", "rm-discussion <DISCUSSION_ID> [FLAG...]\n")
	writeLine("  Examples:", "rm-discussion 15 [Deletes the discussion with ID 15]\n")
	writeLine("  Arguments:", "")
	writeLine("   <DISCUSSION_ID>", "Numeric ID of the discussion to delete (required)\n")
	writeLine("  Flags:", "All flags listed below are OPTIONAL")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintRmReplyHelp() int {
	writer := tabwriter.NewWriter(os.Stdout, 0, 8, 1, '\t', tabwriter.AlignRight)
	writeLine := newLineWriter(writer)

	writeLine("  ", "  ")
	writeLine("  For:", "Deleting a discussion reply (answer or comment) by its numeric ID.\n")
	writeLine("  Usage:", "rm-reply <REPLY_ID> [FLAG...]\n")
	writeLine("  Examples:", "rm-reply 25 [Deletes the reply with ID 25]\n")
	writeLine("  Arguments:", "")
	writeLine("   <REPLY_ID>", "Numeric ID of the reply (answer or comment) to delete (required)\n")
	writeLine("  Flags:", "All flags listed below are OPTIONAL")
	writeLine("   -h, -help", "Displays this help message and exits")
	writeLine("   -json", "Displays response in JSON format")
...
func PrintSetTagsHelp() int {
	...
	writeLine("  ", "  ")
	writeLine("  For:", "Setting tags on an entity. Supported: app, dbcluster, file, folder, job, workflow. This replaces existing tags.\n")
...
func PrintSetPropertiesHelp() int {
	...
	writeLine("  ", "  ")
	writeLine("  For:", "Setting properties on an entity. Supported: app, dbcluster, file, folder, job, workflow. This replaces existing properties.\n")
