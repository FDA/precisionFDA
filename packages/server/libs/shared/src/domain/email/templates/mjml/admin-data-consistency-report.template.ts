  ...
  ${header}
    <mj-section css-class="header-title">
      <mj-column>
        ...
        <mj-text color="#666" align="center">${(data.content.httpsFilesCount)} HTTPS files found</mj-text>
        <mj-text color="#666" align="center">${(data.content.httpsFoldersCount)} HTTPS folders found</mj-text>
      </mj-column>
    </mj-section>
