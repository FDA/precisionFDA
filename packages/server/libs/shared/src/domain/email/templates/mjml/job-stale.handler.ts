  ...
  ${header}
    ...
    <mj-section css-class="body-section">
      <mj-column>
        ...
        <mj-text>
          You may save work on the Workstation by connecting to the Workstation and using 'pfda upload-file' to push individual files to your precisionFDA private cloud environment.  You may also click the Snapshot button on the Workstation execution's detail page in the precisionFDA website to create a saved snapshot archive of the entire Workstation instance, including all files.  Snapshots will take several minutes to create but are automatically uploaded to the precisionFDA cloud after creation.
        </mj-text>
