      ...
      const dataPortals = {
        daaas: {
          accessible:
            dataPortalsList.find(
              (portal) => portal.name === 'FDA Data Analytics as a Service (DAaaS)',
            ) !== undefined,
        ...
        prism: {
          accessible:
            dataPortalsList.find(
              (portal) =>
                portal.name === 'PRISM – precisionFDA Regulatory Information Service Module ',
            ) !== undefined,
        ...
        tools: {
          accessible:
            dataPortalsList.find(
              (portal) => portal.name === 'PrecisionFDA Getting Started and Next Steps',
            ) !== undefined,
          tooltipText:
