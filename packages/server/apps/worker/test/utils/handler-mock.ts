...
const jobToProcessorMap: Partial<Record<TASK_TYPE, (job: Job) => Promise<void> | void>> = {
  ...
  [TASK_TYPE.CHECK_NON_TERMINATED_DBCLUSTERS]: () => processor.MAINTENANCE().checkNonTerminatedDbClusters(),
  ...
  [TASK_TYPE.ADMIN_DATA_CONSISTENCY_REPORT]: () => processor.MAINTENANCE().reportAdminDataConsistency(),
