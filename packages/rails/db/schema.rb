...
ActiveRecord::Schema[7.1].define(version: 2026_06_11_194727) do
  ...
  create_table "admin_groups", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "admin_memberships", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "appathons", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.integer "admin_id"
  ...
  create_table "apps", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "apps_assets", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "app_id"
    t.integer "asset_id"
  ...
  create_table "archive_entries", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.text "path"
    t.string "name"
    t.integer "asset_id"
  ...
  create_table "challenge_resources", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "challenges", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.integer "admin_id"
  ...
  create_table "comparison_inputs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "comparisons", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "user_id"
    t.string "state"
  ...
  create_table "expert_answers", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "expert_id"
  ...
  create_table "expert_questions", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "expert_id"
    t.integer "user_id"
    t.text "body"
    t.text "meta"
  ...
  create_table "job_inputs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "job_id"
    t.integer "user_file_id"
  ...
  create_table "licensed_items", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "license_id"
  ...
  create_table "licenses", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.text "content"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "meta_appathons", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "handle"
    t.string "template"
    t.text "description"
  ...
  create_table "news_items", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "link"
    t.date "when"
    t.text "content"
  ...
  create_table "nodes", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "dxid", collation: "utf8mb3_bin"
    t.string "project"
    t.string "name"
    t.string "state"
  ...
  create_table "notification_preferences", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.text "data"
  ...
  create_table "org_action_requests", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "participants", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "image_url"
    t.integer "node_id"
    t.boolean "public"
  ...
  create_table "phone_confirmations", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "number", null: false
    t.string "code", null: false
    t.datetime "expired_at", null: false
  end

  create_table "profiles", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "address1"
    t.string "address2"
    t.string "city"
    t.string "email"
  ...
  create_table "properties", primary_key: ["target_id", "target_type", "property_name"], charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "saved_queries", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "grid_name"
    t.text "query"
    t.text "description"
  ...
  create_table "space_events", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "space_memberships", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.text "meta"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "space_report_parts", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "tmp_locked_folder_nodes_backup", id: false, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "id", default: 0, null: false
  end

  create_table "truth_challenge_results", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "answer_id"
    t.string "entry"
    t.string "type"
    t.string "subtype"
  ...
  create_table "usage_metrics", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "workflow_series", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "dxid"
    t.string "name"
  ...
  create_table "workflows", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "name"
    t.string "dxid", collation: "utf8mb3_bin"
    t.integer "user_id"
