    ...
    def default_preferences
      {
        ...
        reviewer_comment_activity: 0,
        reviewer_content_added_or_deleted: 0,
        sponsor_membership_changed: 0,
        sponsor_comment_activity: 0,
        sponsor_content_added_or_deleted: 0,
        reviewer_lead_membership_changed: 0,
        reviewer_lead_comment_activity: 0,
        reviewer_lead_content_added_or_deleted: 0,
        reviewer_lead_member_added_to_space: 0,
        reviewer_lead_space_locked_unlocked_deleted: 0,
        sponsor_lead_membership_changed: 0,
        sponsor_lead_comment_activity: 0,
        sponsor_lead_content_added_or_deleted: 0,
        sponsor_lead_member_added_to_space: 0,
        sponsor_lead_space_locked_unlocked_deleted: 0,
