...
> [!info] Tip
> You can always use [the tracking feature](/guides/tracking) to review the permissions of an item and its related items, both before and after publication. This will give you an idea of what is accessible to everybody (shown in green) versus only to you (shown in white).
