...
<div className="flex gap-4 shrink">
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-linux-2.11.2.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-darwin-2.11.2.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-windows-2.11.2.zip" className='no-underline' target="_blank" rel="noreferrer">
