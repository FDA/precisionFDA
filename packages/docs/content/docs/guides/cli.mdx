...
<div className="flex gap-4 shrink">
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-linux-2.14.0.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-darwin-2.14.0.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-windows-2.14.0.zip" className='no-underline' target="_blank" rel="noreferrer">
...
|---|---|
| Version 2.14.0 (07/27/2026) | New features: rmdir -r flag for deleting non-empty folders, -debug flag for HTTP request/response tracing; bug fixes and improvements |
| Version 2.13.0 (06/30/2026) | {/* New features: rm-discussion, rm-reply; */}Bug fixes and improvements; upgraded Go to 1.26.4 with native FIPS 140-3 support |
...
| Version 2.0.0 (6/21/2018) | TLS 1.2 and FIPS support |
