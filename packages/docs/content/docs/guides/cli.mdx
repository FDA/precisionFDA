...
<div className="flex gap-4 shrink">
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-linux-2.13.0.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-darwin-2.13.0.tar.gz" className='no-underline' target="_blank" rel="noreferrer">
  ...
  <a href="https://pfda-production-static-files.s3.amazonaws.com/cli/pfda-windows-2.13.0.zip" className='no-underline' target="_blank" rel="noreferrer">
