...
Inspired by the [Notes](/guides/notes) feature, Discussions build a more communal experience by allowing precisionFDA users to pose discussion topics, and members of the community to juxtapose their answers.
...
To write an answer to a Discussion, check the "Mark as answer" checkbox on the discussion response.

## Commenting

Members with "contributor" roles, can comment on any discussion or answer.
