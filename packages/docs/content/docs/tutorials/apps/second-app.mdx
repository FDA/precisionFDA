...
![Create App form with the I/O Spec tab open](./assets/image21.png)
...
![VM Environment tab with internet access enabled and assets selected](./assets/image22.png)
...
Select View Logs from the Actions dropdown menu. Let's look at a condensed and annotated version of the log output to understand what our app just did.
```bash
