...
![Adding the workstation local database as a new server in pgAdmin (1 of 2)](./assets/image-1.png)

![Adding the workstation local database as a new server in pgAdmin (2 of 2)](./assets/image-2.png)
...
![RStudio environments panel](./assets/image-6.png)

![RStudio files list](./assets/image-7.png)
