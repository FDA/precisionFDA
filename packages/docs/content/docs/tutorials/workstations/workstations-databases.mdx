...
![Locating the epidemic_modeling.ipynb file ID (1 of 2)](./assets/image-111.png)

![Locating the epidemic_modeling.ipynb file ID (2 of 2)](./assets/image-112.png)
...
![Launching the epidemic modeling notebook (1 of 2)](./assets/image-113.png)

![Launching the epidemic modeling notebook (2 of 2)](./assets/image-114.png)
