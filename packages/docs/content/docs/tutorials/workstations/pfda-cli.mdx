...
![My Home Assets with the How to create assets button](./assets/image-97.png)

<div className="flex flex-col gap-4">

![precisionFDA CLI download links](./assets/image-98.png)

![Generating a temporary CLI authorization key](./assets/image-99.png)
