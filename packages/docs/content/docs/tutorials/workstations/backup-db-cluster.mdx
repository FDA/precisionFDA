...
![My Home Assets with the How to create assets button](./assets/image-74.png)

<div className="flex flex-col gap-4">

![Generating a temporary CLI authorization key (1 of 2)](./assets/image-75.png)

![Generating a temporary CLI authorization key (2 of 2)](./assets/image-76.png)
...
![My Home Assets with the How to create assets button](./assets/image-84.png)

<div className="flex flex-col gap-4">

![Generating a temporary CLI authorization key (1 of 2)](./assets/image-85.png)

![Generating a temporary CLI authorization key (2 of 2)](./assets/image-86.png)
