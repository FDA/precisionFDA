...
![pgAdmin connection settings](./assets/image-26.png)

![pgAdmin database list](./assets/image-27.png)
...
![Restarting KNIME to pick up the newly added files](./assets/image-28.png)
...
![Configuring the pfdacli-access-key String Widget (1 of 2)](./assets/image-36.png)

![Configuring the pfdacli-access-key String Widget (2 of 2)](./assets/image-37.png)
...
![Configuring the datasource-folderid String Widget (1 of 2)](./assets/image-38.png)

![Configuring the datasource-folderid String Widget (2 of 2)](./assets/image-39.png)
...
![Create ehr_data DB tables with primary keys node (1 of 2)](./assets/image-40.png)

![Create ehr_data DB tables with primary keys node (2 of 2)](./assets/image-41.png)
...
![Ingest compressed EHR Data files from precisionFDA node (1 of 2)](./assets/image-43.png)

![Ingest compressed EHR Data files from precisionFDA node (2 of 2)](./assets/image-44.png)
...
![ETL EHR Data into a PostgreSQL DB node (1 of 2)](./assets/image-46.png)

![ETL EHR Data into a PostgreSQL DB node (2 of 2)](./assets/image-47.png)
...
![Checking the DB for content in pgAdmin (1 of 2)](./assets/image-48.png)

![Checking the DB for content in pgAdmin (2 of 2)](./assets/image-49.png)
...
![Dashboard node interactive view: data table](./assets/image-50.png)

![Dashboard node interactive view: geomap](./assets/image-51.png)
