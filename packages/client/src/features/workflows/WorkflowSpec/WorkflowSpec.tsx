  ...
  return (
    <div className="__table-divider">
      <div className="__table">
        ...
        <div className="__table_row">No fields specified</div>
      </div>
    </div>
  )
}
        ...
        <div className="__header">
          ...
          <div className="__header_item">
            ...
            <MetadataVal data-testid={`workflow-stage-${stage.stageIndex + 1}-app-default-instance-type`}>
              {COMPUTE_RESOURCE_LABELS[stage.instanceType] ?? stage.instanceType}
            </MetadataVal>
          </div>
        </div>
...
const HomeWorkflowsSpec = ({ spec = {} as Spec }: { spec?: Spec }) => {
  return <StyledSpecTab>{spec.input_spec && renderSpecs(spec.input_spec.stages)}</StyledSpecTab>
}

export default HomeWorkflowsSpec

export { HomeWorkflowsSpec }
