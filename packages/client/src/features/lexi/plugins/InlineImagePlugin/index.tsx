...
export function InsertInlineImageDialog({
  ...
  const handleOnClick = (input: InsertImagePayload) => {
    const payload = { altText: input.altText, position, showCaption, src: input.src }
    activeEditor.dispatchCommand(INSERT_INLINE_IMAGE_COMMAND, payload)
    onClose()
  }

  if (insertImageType === 'resource') return <InsertResourceImageDialogBody onClick={handleOnClick} />
  return <InsertImageUriDialogBody onClick={handleOnClick} />
}
