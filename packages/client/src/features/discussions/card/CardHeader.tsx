...
import { CardLeft, CardRight, StyledAnswerLabel, StyledCardHeader, StyledEditButton, UsernameLink } from '../discussions.styles'
    ...
    <StyledCardHeader>
      ...
      <CardRight>
        ...
        {canUserEdit && (
          <Menu
            trigger={
              <Menu.Trigger className={styles.editButton} data-testid={`${cardType}-dropdown`} tabIndex={0}>
