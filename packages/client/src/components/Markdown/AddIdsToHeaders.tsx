...
export function AddIdsToHeaders({ docRef, content, as = 'div', onHeadersUpdated }: { docRef: React.MutableRefObject<HTMLDivElement | null>, content: string | null | undefined, as?: React.ElementType, onHeadersUpdated: (headings: NodeListOf<Element>) => void }) {
  ...
  return (
    <Content as={as} ref={docRef} dangerouslySetInnerHTML={{ __html: processedContent }} />
  )
}
