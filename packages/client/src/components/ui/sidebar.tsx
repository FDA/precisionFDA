...
function SidebarProvider({
  ...
  /** Keep the sidebar within its parent instead of fixing to the viewport (below app header). */
  contained?: boolean
}) {
      ...
      <TooltipProvider delay={0}>
        <div
          ...
          className={cn(
            ...
            contained ? 'relative h-full min-h-0' : 'min-h-svh',
            className,
          )}
          {...props}
        >
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className={cn(
            ...
            contained && 'top-below-header h-[calc(100%-var(--spacing-below-header))]!',
          )}
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'z-10 hidden transition-[left,right,width] duration-200 ease-linear md:flex',
          contained ? 'absolute inset-y-0 h-full w-(--sidebar-width)' : 'fixed inset-y-0 h-svh w-(--sidebar-width)',
          side === 'left'
