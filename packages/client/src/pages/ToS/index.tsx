      ...
      <PageContainerMargin>
        <StyledTos>
          ...
          <p>
            ...
            as part of the FDA’s work in building a strong community
            contributing to a standards-based approach for ensuring the accuracy
            of genetic tests incorporating next generation sequencing (NGS)
            technologies. Use of the services made available via PrecisionFDA is
            restricted to usage specifically related to the FDA’s PrecisionFDA
            program as determined by the FDA. The services are offered subject
            to your acceptance of the terms and conditions contained herein as
            well as any relevant sections of the FDA Website Policies.
          </p>
          ...
          <p>
            ...
            developed by FDA or third parties and provided as FDA publicly
            shared data, upload agent, command line tools and other software,
            data, documentation, systems and services licensed and provided by
            FDA for data management and analysis in the performance of
            PrecisionFDA-related tasks. User shall be solely liable for any use
            of the Services. <br />
            ...
            would cause the non-FOSS portions of the Services to be subject to
            any FOSS licensing terms or obligations. Free and Open Source
            Software means any software that is subject to terms that, as a
            condition of use, copying modification or redistribution, require
            such software or derivatives thereof to be disclosed and/or
            distributed in source code form, to be licensed for purposes of
            making derivative works, or to be redistributed free of charge,
            including without limitation software distributed under the GNU
          ...
          <p>
            ...
            are installed on User’s or Users’ behalf, (b) User’s or Users’
            sharing of User Data with any third party and (c) the backup of User
            Data.
            <br />
            ...
            necessary permissions and informed consents have been obtained.{' '}
            <br />
            2.5. Confidential Commercial Information. Users shall not store
            Confidential Commercial Information on PrecisionFDA in a manner
            which renders the information accessible to all Users and the FDA.
            <br />
          ...
          <p>
            ...
            solely in a private space. FDA shall maintain administrative,
          ...
          <p>
            ...
            to access and use the Services, User shall provide complete,
            accurate and up-to-date information, including, for example, email
            addresses used to provide notices to User under this Agreement and
            shall update or correct such information as needed. User shall
            promptly notify FDA of any unauthorized access or use of the
            Services.
            <br />
          </p>
          <p>
            5. Intellectual Property. Except as expressly stated or as required
            by laws of the United States of America, this Agreement does not
            grant either party any rights, implied or otherwise, to the other’s
            intellectual property.
            <br />
            5.1. User IP. As between the parties, User has and shall retain all
            right, title and interest, including Intellectual Property Rights,
            in and to User Data (“User IP”). “Intellectual Property Rights”
            means all current and future worldwide rights under the laws of
            patents, copyrights, trade secrets, trademarks, moral rights and
            other intellectual property. User hereby grants FDA a nonexclusive,
            nontransferable, revocable, royalty- free, limited license during
            the term of this Agreement to access and use User IP solely for the
          ...
          <p>
            ...
            regulations of the Department of Commerce and any other United
            States or foreign agencies and authorities in connection with User’s
            use of the Services. In particular, but without limitation, User
            shall not export or re-export the Services in violation of any laws
            into any US embargoed country or to anyone on the US Treasury
          ...
          <p>
            ...
            <br />
            7.1. Availability; Backups. FDA makes no representations or
            warranties regarding the durability or availability of third party
            cloud services, such as Amazon Web Services, that FDA uses to
            provide the Services. FDA will have no obligation to back up User
            Data or any other software, data or information provided by User or
            Users.
            <br />
          </p>
          <p>
            ...
            <br />
            8.1. Term. The term of this Agreement begins on the date of
            acceptance of these Terms of Service or date of the first use of
            Services, whichever is earlier. The term of this agreement ends upon
            Termination for Any Reason, Termination for Breach, or Termination
            of Services, whichever occurs first.
            <br />
            8.2. Termination for Any Reason. Either party may terminate this
            Agreement at any time provided at least 30 days’ prior written
            notice of termination is provided to the other party.
            <br />
            8.3. Termination for Breach. Either party may terminate this
            Agreement for material breach upon 15 days’ notice if the material
            ...
            terminate, and FDA will have no obligation to store or provide
